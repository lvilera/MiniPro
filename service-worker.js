// Service Worker for Sports Card Album
const CACHE_NAME = 'sports-card-album-v2.0.0';
const urlsToCache = [
    '/',
    '/index.html',
    '/styles.css',
...
self.addEventListener('push', (event) => {
    const options = {
        body: event.data ? event.data.text() : 'New cards available!',
    ...
    event.waitUntil(
        self.registration.showNotification('Sports Card Album', options)
    );
});
